  ...
  describe('Intelligent User Registration with Function Calls', () => {
    it('should process user message and trigger register_user function call', async () => {
      ...
      const mockGeminiResponse = {
        response:
          'Olá! Vou te ajudar com seu problema jurídico. Primeiro, preciso de algumas informações.',
        functionCalls: [
          {
            ...
            parameters: {
              ...
              phone: '+5511999999999',
              problem_description:
                'Preciso de ajuda com um contrato de trabalho',
      ...
      (intelligentRegistrationService as any).conversationModel =
    ...
    it('should process user message and trigger update_conversation_status function call', async () => {
      ...
      const mockGeminiResponse = {
        response:
          'Analisei seu caso e acredito que você precisa de um advogado especializado em direito trabalhista.',
        functionCalls: [
          {
            ...
            parameters: {
              ...
              notes:
                'Caso complexo envolvendo contrato de trabalho e direitos trabalhistas',
            },
          },
        ],
      };
    ...
    it('should handle multiple function calls in sequence', async () => {
      ...
      const mockGeminiResponse1 = {
        response:
          'Olá! Vou te ajudar. Primeiro preciso registrar suas informações.',
        functionCalls: [
          {
            name: 'register_user' as const,
            parameters: {
      ...
      const mockGeminiResponse2 = {
        response:
          'Seu caso é urgente e complexo. Vou conectar você com um advogado especialista.',
        functionCalls: [
          {
            name: 'update_conversation_status' as const,
            parameters: {
